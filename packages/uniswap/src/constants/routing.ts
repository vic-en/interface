...
export const COMMON_BASES: ChainCurrencyList = {
  ...
  [UniverseChainId.Wonder]: [
    nativeOnChain(UniverseChainId.Wonder),
    USDC_WONDER,
    WRAPPED_NATIVE_CURRENCY[UniverseChainId.Wonder] as Token,
  ].map(buildPartialCurrencyInfo),
}
...
function getNativeLogoURI(chainId: UniverseChainId = UniverseChainId.Wonder): ImageSourcePropType {
  if (chainId === UniverseChainId.Wonder) {
