...
import { Ether } from '@unifinance/sdk-core'
...
const USDC_CURRENCY_ID = idFromCurrency(USDC_WONDER).toLowerCase()
const ETH_CURRENCY_ID = idFromCurrency(Ether.onChain(UniverseChainId.Wonder)).toLowerCase()
